...
UI.registerHelper("activeRouteClassById", function(id) {
    Router.current().path;
...
UI.registerHelper("getArchive", function(filepath) {
...
UI.registerHelper("getImageUser", function(userId) {
    try {
        ...
        if (anySocial) return window.location.origin+"/images/withOutPhoto.png";
    } catch (e) {
...
UI.registerHelper("Iam", function(userId) {
    if (userId==Meteor.userId())
        return true
    else
        return false
